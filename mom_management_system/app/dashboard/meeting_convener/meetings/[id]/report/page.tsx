...
export default async function MeetingReportConvener({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="print:hidden p-6 bg-slate-50 border-b flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <Link 
            href={`/dashboard/meeting_convener/meetings/${id}`}
          ...
          <button 
            id="print-btn"
            className="px-6 py-3 bg-black text-white rounded-xl font-bold flex items-center gap-2 shadow-lg hover:bg-slate-900 transition-all active:scale-95"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M7.5 12l4.5 4.5m0 0l4.5-4.5M12 3v13.5" />
            </svg>
            Download Report
          </button>
        </div>
      ...
      <div className="max-w-4xl mx-auto p-10 print:p-0">
        ...
        <div className="grid grid-cols-2 gap-8 mb-10 text-slate-700">
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            <p className="text-xs font-bold text-black uppercase tracking-widest mb-1">Date & Time</p>
          ...
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            <p className="text-xs font-bold text-black uppercase tracking-widest mb-1">Status</p>
        ...
        {/* Description */}
        <div className="mb-10">
          <h3 className="text-xl font-black text-slate-800 border-b-2 border-slate-200 pb-2 mb-4 uppercase tracking-tighter">Agenda & Description</h3>
        ...
        <div className="mb-10 page-break-inside-avoid">
          <h3 className="text-xl font-black text-slate-800 border-b-2 border-slate-200 pb-2 mb-4 uppercase tracking-tighter">Attendance Roster</h3>
        ...
        <div className="mt-16 pt-8 border-t-2 border-slate-200 text-center text-sm font-medium text-slate-400 print:fixed print:bottom-10 print:w-[calc(100%-5rem)]">
          ...
          <p className="max-w-md mx-auto mt-2 text-xs">This is a system generated report. For modifications, please access the digital record via the management portal.</p>
        </div>
